...
// ParseGeminiCLIUsage parses Gemini CLI usage metadata into a usage.Detail. (fork)
...
// ParseGeminiCLIStreamUsage parses a Gemini CLI streaming JSON chunk for usage metadata. (fork)
